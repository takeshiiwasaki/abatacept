...
#Preparation
p=pd.read_table("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/pheno.xls")
e=pd.read_table("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/expr.xls")

p["ID"]=p.index
p.index=range(len(p))
for i in range(len(p)):
    if p.loc[i,"title"].startswith("Low"):
        p.loc[i,"Target"]="zero"
    elif p.loc[i,"title"].startswith("no"):
        p.loc[i,"Target"]="one"
p=p[["ID","Target"]]
p.to_csv("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/design.xls",sep="\t",index=False)

##Gene Annotatation for expression file
a = pd.read_table("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/GPL4133-12599.xls")
a = a[["ID","GENE_SYMBOL"]]
e["ID"] = e.index
m=pd.merge(e,a,on="ID",how="outer").dropna().drop_duplicates().reset_index(drop=True)
m=m.rename(columns={'GENE_SYMBOL':'Symbol'})
m=m.drop('ID', axis=1)
...
e_final.to_csv("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/expr_target_annotate.xls",sep="\t",index=True)

#Read input file
data = pd.read_table('C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/expr_target_annotate.xls')
data=data.rename(columns={'Unnamed: 0': 'ID'})
data=data.set_index("ID")
design = pd.read_table('C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/design.xls') #replace with your own design file
...
writexl.write_xlsx(r_output, "C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xlsx")
pd.read_excel("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xlsx").to_csv("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xls",sep="\t",index=False)

#Since direction was opposite
d=pd.read_excel("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xlsx")
d["logFC"]=-d["logFC"]
d.to_excel("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xlsx",index=False)
d.to_csv("C:/Users/tiwasaki/Documents/RA_RNA.ABT/GSE68215/limma_output.xls",sep="\t",index=False)
